    ...
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">tomstevvenson@gmail.com</span>
                            
                            <a href="mailto:tomstevvenson@gmail.com" className="contact__button">
                                Write Me{" "} 
                ...
                <div className="contact__content">
                    <h3 className="contact__title">What do you want to talk about?</h3>
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="message" cols="30" rows="10" className="contact__form-input" placeholder="Provide your main message here..." required></textarea>
                        </div>
